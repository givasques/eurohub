...
public class ColaboradorResponse {
    ...
    public ColaboradorResponse toDto(Colaborador colaborador) {
        ...
        this.status = colaborador.getStatus().getMensagem();
        this.createdAt = colaborador.getCreatedAt();
        this.updatedAt = colaborador.getUpdatedAt();
        return this;
    }
